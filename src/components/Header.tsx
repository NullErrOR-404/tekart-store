        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-50 flex">
            ...
            <motion.div
              ...
              className="relative flex w-full max-w-xs flex-col bg-white dark:bg-tk-surface p-6 shadow-2xl z-10 h-full"
            >
              <div className="flex items-center justify-between border-b border-tk-border pb-4">
                ...
                <button
                  onClick={() => setIsMenuOpen(false)}
                  className="p-2 -mr-2 text-tk-text-secondary hover:text-tk-text-primary cursor-pointer"
              ...
              <div className="border-t border-tk-border pt-4 pb-4">
                ...
                <div className="flex bg-tk-blue-pale dark:bg-tk-surface-2 p-1 rounded-tk-input border border-tk-border">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-tk-chip text-[11px] font-semibold transition-all cursor-pointer ${
                      theme === 'light'
